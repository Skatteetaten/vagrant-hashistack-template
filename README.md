...
### Getting started
There is a separate file called `getting_started.md` that will guide you through creating your first terraform module using this template. If you don't know where to start, start there!
